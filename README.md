...
| ------  | ------  | ------ | ------ | 
| `[T-Display-AMOLED-1.64_V1.0][Light_Sleep_Wake_Up]_firmware_V1.0.0.bin` | `Light Sleep Wake Up` | Power dissipation: 2259.7uA | <p align="center" width="5%"> <img src="image/13.jpg" alt="example"> </p> |
| `[T-Display-AMOLED-1.64_V1.0][Deep_Sleep_Wake_Up]_firmware_V1.0.0.bin` | `Deep Sleep Wake Up` | Power dissipation: 254.5uA |<p align="center" width="5%"> <img src="image/12.jpg" alt="example"> </p> |
